...
\end{itemize}
Font:\href{https://ca.wikipedia.org/wiki/KDE}{wWikipedia}
...
A l'hora de crear un projecte en equip, pot arribar a ser complicat treballar amb 2 o més membres del grup a la vegada en els seus respectius dispositius si no s'escull una eina col·laborativa adequada, sobretot si s'està treballant amb molts fichers. En el nostre cas, vam escollir el software de git.
\subsection{Git}
