...
\subsection{Windows}\label{subsec:Microsoft Windows}
Windows és un sistema operatiu creat per la companyia Microsoft aproximadament en els anys 80. El sistema operatiu va ser tan popular que el seu màrqueting va arribar a un 90\% de la quota de mercat.
