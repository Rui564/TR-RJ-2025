...
\begin{itemize}
 ...
 \item \textbf{Coneixements previs:} Fer una XNA amb Python requereix de coneixements de programació, apendre el llenguatge és indispensable per crear una xarxa neuronal, en canvi, en la XNA feta amb fulls de càlculs no ha calgut cap tipus de coneixements de programació.
  \item \textbf{Facilitat:} Segons la experència de cadascún de nosaltres, fer una XNA amb fulls de càlculs és molt més fàcil que fer-ho amb Python, a banda de que no cal saber programar, el procès és molt més intuïtiu i automàtic, mentre que en Python has d'anar codificant-lo tot manualment.
  \item\textbf{Tardança:} El temps que es requereix en fer una XNA amb Python depèn de la habilitat que tingui un en la programació, si la persona és àgil i coneix bé el llenguatge pot fer-la en molt poc tempx, mentre que en un full de càlcul, malgrat que les dades i els càlculs s'obtenen automàticament, les etapes es fan manualment, cosa que es torna repetitiva i requereix molt de temps.
\end{itemize}
