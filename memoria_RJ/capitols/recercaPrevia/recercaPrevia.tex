...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        És una branca crucial de la intel·ligència artificial, consisteix a dotar de vida a la màquina, donar-li el poder d'aprendre com els humans, executar tasques de manera autònoma i finalment, les infinites possibilitats d'evolucionar a través de l'experiència i més funcions. Segons la UC Berkeley~\cite{Berkeley} el procés de l'aprenentatge automàtic consta de:
        \begin{enumerate}
...
\clearpage
    ...
    Aquesta funció aplica el següent algoritme:
    \begin{itemize}
