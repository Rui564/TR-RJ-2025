...
\subsection{Funció d'activació}\label{sec:3.5.3}
...
Una funció d'activació molt coneguda és la funció sigmoide, que té el seguent aspecte:
\(\sigma(x) = \frac{1}{1 + e^{-x}}\)
Aquesta funció matemàtica transforma qualsevol valor d'entrada real en un valor que està entre el zero i l'ú.
