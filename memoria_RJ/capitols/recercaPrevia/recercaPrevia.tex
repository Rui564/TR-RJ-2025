...
L’optimització és el procés de trobar els millors paràmetres (com pesos i biaixos) per a què el model minimitzi l’error en les seves prediccions. Aquesta té diverses maneres per controlar els errors, uns dels més destacats son la \nameref{subsec:propagació}, \nameref{subsec:retropropagació} i \nameref{subsec:Gardients}.
